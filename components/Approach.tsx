...
const Approach = () => {
  return (
    <section className='w-full py-20'>
      <h1 className='heading text-2xl font-bold tracking-wider text-center'>
  ...
  return (
    <div>
      <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
        ...
        <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-5 py-2 text-2xl font-bold text-white backdrop-blur-3xl text-center">
          {order}
        </span>
      </button>
    </div>
